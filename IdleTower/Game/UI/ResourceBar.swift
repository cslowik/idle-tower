...
class ResourceBar: SKNode {
    ...
    private func setupUI() {
        ...
        let background = SKShapeNode(rectOf: CGSize(width: 1000, height: 90))
        ...
        materialsLabel.position = CGPoint(x: -450, y: 20)
        ...
        energyLabel.position = CGPoint(x: -450, y: -10)
        ...
        dataLabel.position = CGPoint(x: -450, y: -40)
